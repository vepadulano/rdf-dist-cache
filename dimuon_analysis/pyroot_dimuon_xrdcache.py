...
parser.add_argument(
    "nthreads",
    help="Number of threads for multithreaded execution.",
    type=int)
...
def dimuonSpectrum(df):
    ...
    with open("pyroot_dimuon_xrdcache_analysistimes.csv", "a+") as f:
...
for i in range(1,11):
    ...
    with open("pyroot_dimuon_xrdcache_{}threads.csv"
              .format(args.nthreads), "a+") as f:
