...
def dimuonSpectrum(df):
    ...
    with open("pyrdf_dimuon_multinode_scratchssd_analysistimes.csv", "a+") as f:
...
filenames = [("/local/scratch/ssd/vpadulano/"
...
for i in range(1):
    ...
    with open("pyrdf_dimuon_multinode_scratchssd_{}partitions.csv"
