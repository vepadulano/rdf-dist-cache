...
def dimuonSpectrum(df):
    ...
    with open("sg02_pyrdf_dimuon_intranode_xrdcache_scratchssd_analysistimes.csv", "a+") as f:
...
for i in range(1,6):
    ...
    with open("sg02_pyrdf_dimuon_intranode_xrdcache_scratchssd_{}partitions.csv"
