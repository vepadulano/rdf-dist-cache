...
filenames = [("root://eospublic.cern.ch/"
             ...
             for i in range(1, 41)]
haddfile = "root://eospublic.cern.ch//eos/root-eos/benchmark/CMSOpenDataDimuon/Run2012BC_DoubleMuParked_Muons_x4.root"
...
for i in range(1,6):
    ...
    with open("pyrdf_dimuon_tfileprefetch_rdfmt40files_{}partitions.csv"
