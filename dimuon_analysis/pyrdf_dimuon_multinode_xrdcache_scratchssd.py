...
os.environ["XROOT_PROXY"]="root://sg01.etp.kit.edu:2002//"
...
def dimuonSpectrum(df):
    ...
    with open("pyrdf_dimuon_multinode_xrdcache_scratchssd_analysistimes.csv", "a+") as f:
...
for i in range(5):
    ...
    with open("pyrdf_dimuon_multinode_xrdcache_scratchssd_{}partitions.csv"
