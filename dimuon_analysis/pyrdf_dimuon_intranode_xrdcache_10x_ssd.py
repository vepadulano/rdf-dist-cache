...
os.environ["XROOT_PROXY"]="root://sg02.etp.kit.edu:2002//"
...
PyRDF.use("spark", conf={
    ...
    'spark.executor.cores': args.npartitions,
    'use_xrdcaching': True,
})
...
def dimuonSpectrum(df):
    ...
    with open("sg02_pyrdf_dimuon_intranode_xrdcache_10x_ssd_analysistimes.csv", "a+") as f:
...
for i in range(1,4):
    ...
    with open("sg02_pyrdf_dimuon_intranode_xrdcache_10x_ssd_{}partitions.csv"
