...
def dimuonSpectrum(df):
    ...
    with open("sg02_pyroot_dimuon_intranode_xrdcache_htdacache_analysistimes.csv", "a+") as f:
...
for i in range(1,3):
    ...
    with open("sg02_pyroot_dimuon_intranode_xrdcache_htdacache_{}threads.csv"
