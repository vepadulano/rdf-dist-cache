...
def dimuonSpectrum(df):
    ...
    with open("pyrdf_dimuon_multinode_htdacache_analysistimes.csv", "a+") as f:
...
for i in range(1):
    ...
    with open("pyrdf_dimuon_multinode_htdacache_{}partitions.csv"
