...
ROOT.EnableImplicitMT(args.npartitions)
...
def dimuonSpectrum(df):
    ...
    with open("sg02_pyroot_dimuon_intranode_xrdcache_scratchssd_analysistimes.csv", "a+") as f:
...
for i in range(1,11):
    ...
    with open("sg02_pyroot_dimuon_intranode_xrdcache_scratchssd_{}threads.csv"
