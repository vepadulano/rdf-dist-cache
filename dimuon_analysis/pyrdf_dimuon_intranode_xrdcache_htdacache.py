...
def dimuonSpectrum(df):
    ...
    with open("sg02_pyrdf_dimuon_intranode_xrdcache_htdacache_100files_analysistimes.csv", "a+") as f:
...
for i in range(1, 3):
    ...
    with open("sg02_pyrdf_dimuon_intranode_xrdcache_htdacache_100files_{}partitions.csv"
